                            ...
                            <div className="flex items-start gap-4 min-w-0 flex-1">
                              ...
                              <div className="space-y-1.5 min-w-0 flex-1">
                                ...
                                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-600">
                                  ...
                                  {(Boolean(p.rentPrice2Days) || Boolean(p.rentPrice3Days)) && (
                                  ...
                                  {Boolean(p.rentPrice3Days) && (
                                    <span>Giá 3 ngày: <strong className="text-brand-700 font-semibold">{formatVND(p.rentPrice3Days || 0)}</strong></span>
                                  )}
